...
<form method="POST" ACTION="process_update_project.jsp"  NAME="DesignForm">
<input type="hidden" name="SucessURL" VALUE="design_beam.jsp">
<input type="hidden" name="ErrorURL" VALUE="update_project.jsp">
<table width="100%">
  <tr>
...
project.setPreviousName(projectName);
%>
