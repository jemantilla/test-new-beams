...
public class ConnectionPool {
  ...
  private static final String URL = "jdbc:odbc:ahnemankirbyforms";
  ...
  private ConnectionPool() {
      ...
      try{
          ...
          for(int i=0; i<5; i++) {
              connections.put(DriverManager.getConnection(URL,"sa","tga59"),Boolean.FALSE);
              TotalConnection++;
              FreeConnection++;
  ...
  public Connection getConnection() throws SQLException {
    ...
    for(int i = 0; i < increment; i++) {
      connections.put(DriverManager.getConnection(URL),Boolean.FALSE);
      TotalConnection++;
      FreeConnection++;
