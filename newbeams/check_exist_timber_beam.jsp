...
<FORM METHOD="POST" action="process_check_exist_timber_beam.jsp">
...
<FORM METHOD="POST" action="process_check_exist_timber_beam.jsp">
<INPUT TYPE="HIDDEN" NAME="SucessURL" VALUE="check_exist_timber.jsp">
...
<TABLE ALIGN="CENTER">
    <TR><TD>&nbsp;</TD></TR>
    <TR VALIGN="TOP" class="a12blackbold"><TD><A HREF="check_exist_timber.jsp">Go Back</A></TD></TR>
</TABLE>
        </TD>
    </TD>
</TABLE>
