...
<FORM ACTION="process_result_alternate_beam.jsp" METHOD="POST">
...
<table width="100%">
  <tr>
    ...
    <table border=1 cellpadding=2 cellspacing=2 width="65%" align="CENTER" bgcolor="#DBEAF5">
      <TR>
      <td class="a10blackbold" colspan="2" align="center">The Alternate Beam chosen is good</td>
      </TR>
        <tr>
